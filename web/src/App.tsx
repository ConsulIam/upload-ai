...
export function App() {
  ...
  const {
    ...
    api: 'http://localhost:11337/ai/complete',
    body: {
      videoId,
      temperature,
    },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div>
        <div className="text-xl font-bold">Upload AI</div>
        <span className="block text-xs text-muted-foreground italic">
          Transforming your videos into words
        </span>
      </div>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea 
            className="resize-none p-4 leading-relaxed snap-none"
            placeholder="Please include the text for the AI..."
            value={input}
            onChange={handleInputChange}
            />
            <Textarea 
            className="resize-none p-4 leading-relaxed"
            placeholder="Text generated for the AI..."
            readOnly 
            value={completion}
            />
          </div>
